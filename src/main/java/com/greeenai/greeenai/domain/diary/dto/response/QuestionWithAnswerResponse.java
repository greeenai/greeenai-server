...
public record QuestionWithAnswerResponse(Long id, String content, AnswerResponse answer) {
    public static QuestionWithAnswerResponse from(Question question) {
        return new QuestionWithAnswerResponse(question.getId(), question.getContent(), getQuestionAnswer(question));
    }
